...
public class ChampionsJdbcRepository implements ChampionsRepository {
    ...
    private final RowMapper <Champions> rowMapper; //responsável por fazer a conversão de um resultSet (consulta nativa JDBC) na BD para o record (modelo ou entidade)
